...
final class CreateRestaurantServiceTest extends TestCase
{
    ...
    public function test_it_creates_a_draft_restaurant_for_an_active_owner(): void
    {
        ...
        $this->assertSame(
            RestaurantOperatingStatus::Closed,
            $restaurant->operating_status,
        );
    ...
    public function test_it_generates_a_unique_slug_for_restaurants_with_the_same_name(): void
    {
        ...
        $firstRestaurant = $service->create(
            $firstAccount,
            [
                'name' =>
                    'Crave Test Kitchen',
        ...
        $secondRestaurant = $service->create(
            $secondAccount,
            [
                'name' =>
                    'Crave Test Kitchen',
        ...
        $this->assertSame(
            'crave-test-kitchen-2',
            $secondRestaurant->slug,
        );
    }
    ...
    public function test_an_owner_cannot_create_more_than_one_restaurant(): void
    {
        ...
        $this->expectExceptionMessage(
            'The restaurant owner already has a restaurant.',
        );
